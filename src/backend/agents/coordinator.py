...
_COORDINATOR_PROMPT = (
    ...
    "Decomposition requirements for stage 2:\n"
    "- The user message may include 'Initial retrieval context for decomposition' as JSON.\n"
    "- Use that context to derive context-aware initial sub-questions before delegation.\n"
    "- Prefer entities/concepts present in context titles, snippets, and sources.\n"
    "- Generate one concept per sub-question and always end each sub-question with '?'.\n"
    "- When delegating with task(), pass the exact sub-question in description and keep the trailing '?'.\n"
    "- Do not skip decomposition, even if you can answer directly.\n\n"
    "Sub-question rules:\n"
