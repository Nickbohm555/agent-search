...
2. Build these tests. Then run the required tests from the task definition. Have a fresh build for all tests. You must provide and view logs for every item built. 
