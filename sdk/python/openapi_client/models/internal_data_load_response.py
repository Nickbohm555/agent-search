...
class InternalDataLoadResponse(BaseModel):
    ...
    """ # noqa: E501
    chunks_created: StrictInt
    documents_loaded: StrictInt
    source_type: StrictStr
    status: StrictStr
    __properties: ClassVar[List[str]] = ["chunks_created", "documents_loaded", "source_type", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chunks_created": obj.get("chunks_created"),
            "documents_loaded": obj.get("documents_loaded"),
