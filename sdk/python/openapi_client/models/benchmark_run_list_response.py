...
class BenchmarkRunListResponse(BaseModel):
    ...
    """ # noqa: E501
    runs: Optional[List[BenchmarkRunListItem]] = None
    __properties: ClassVar[List[str]] = ["runs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "runs": [BenchmarkRunListItem.from_dict(_item) for _item in obj["runs"]] if obj.get("runs") is not None else None
        })
        return _obj
