...
class InternalDataLoadJobStatusResponse(BaseModel):
    ...
    status: StrictStr
    total: StrictInt
    __properties: ClassVar[List[str]] = ["completed", "error", "job_id", "message", "response", "status", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "response": InternalDataLoadResponse.from_dict(obj["response"]) if obj.get("response") is not None else None,
